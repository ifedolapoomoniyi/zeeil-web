			...
			>
				...
				<section className="bg-servicesHero h-[92vh] bg-cover flex flex-col items-center justify-center p-4">
					<div className="rounded-2xl  backdrop-blur-lg max-w-[900px] mx-auto md:p-10 p-6 bg-white/35 border border-white">
						...
						<p className="pb-7">
							Explore our diverse range of services designed to
							ensure efficient, secure, and reliable delivery for
							businesses of all sizes. Let us handle your
							logistics, so you can focus on growing your
							business.
						</p>
					</div>
				</section>
				...
				<section className="p-8 md:p-14 my-10">
					<div className=" max-w-4xl m-auto">
						...
						<p className="py-2">
							From last-mile delivery to secure payment systems,
							we provide end-to-end logistics services designed to
							steamline operations and empower businessess to
							thrive
						</p>
					</div>
					...
					<div className="flex flex-row flex-wrap gap-5 items-center justify-center my-10">
						...
						<div className="rounded-2xl p-10 space-y-2 text-black bg-secondary w-96">
							...
							<p className="pt-3">
								...
								placement and management between buyers, vendor,
								and delivery agents
							</p>
						</div>
						...
						<div className="rounded-2xl p-10 space-y-2 text-white bg-primary w-96 ">
							...
							<p className="pt-3">
								A service allowing users to book bike rides
								through the platform, enhancing mobility and
								offering real-time tracking for short-range
								transportation.
							</p>
						</div>
						...
						<div className="rounded-2xl p-10 space-y-2 text-black bg-secondary w-96 ">
							...
							<p className="pt-3">
								A marketplace for individual users to sell
								personal items, such as electronics or
								furniture, with secure payment processing
								through Zeeil’s escrow system.
							</p>
						</div>
					</div>
				</section>
